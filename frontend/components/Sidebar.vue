<template>
    <aside
        v-if="isOpen"
        class="w-60 transform transition-transform duration-300 z-50"
    >
        ...
        >
            <div class="bg-white flex flex-col items-center mb-3 p-5 rounded-xl transition drop-shadow-xl">
                <svg
                    class="size-[80px] mb-3 mt-1 text-p-600 block drop-shadow-np" 
    ...
    <MinimizedSidebar @minimized="isOpen = $event" v-else />
</template>
